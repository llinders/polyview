...
class ConsolidatedPerspective(BaseModel):
    ...
    """
    perspective_name: str = Field(description="A short descriptive name for the perspective (e.g., 'Progressive', 'Libertarian', or 'Techno-Optimist'")
    arguments: List[str]
...
class State(TypedDict):
    ...
    extracted_perspectives: List[ArticlePerspectives]
