...
class FinalPerspective(BaseModel):
    ...
    strengths: list[str] = Field(
        description="An analysis of strengths of the perspective and its argumentation (e.g., well-supported by evidence, logically consistent)"
    )
    weaknesses: list[str] = Field(
        description="An analysis of weaknesses of the perspective and its argumentation (e.g., relies on unstated assumptions, lacks evidence for key claims)"
    )
